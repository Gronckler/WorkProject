...
public class AESUtil {
    ...
    public static void main(String[] args) {
        ...
        String content = "1AiG20+m4cIyc6Lz4wS7ng==";
...
//        byte[] decryptFrom = AESUtil.parseHexStr2Byte(encryptResultStr);
        ...
        byte[] decryptResult = AESUtil.decrypt(decode, password);
        System.out.println("解密后：" + new String(decryptResult));

        System.out.println("U2FsdGVkX19Tw4FUsMa4Nmf4ntATSMBf0kv3Ntcnlok=".length());
